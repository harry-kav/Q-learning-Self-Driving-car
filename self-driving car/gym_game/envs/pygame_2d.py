...
screen_width = 1350
screen_height = 720
check_point = ((100, 100), (450, 150), (230, 200), (220, 475), (950, 125), (1150, 250), (900, 525), (650, 425), (200, 625), (0,475))
...
class Car:
    def __init__(self, car_file, map_file, pos):
        ...
        self.map = pygame.transform.scale(self.map, (1275, 680))
    ...
    def update(self):
        ...
        if self.pos[0] < 5:
            self.pos[0] = 5
        elif self.pos[0] > screen_width - 5:
            self.pos[0] = screen_width - 5
        ...
        if self.pos[1] < 5:
            self.pos[1] = 5
        elif self.pos[1] > screen_height - 5:
            self.pos[1] = screen_height - 5
...
class PyGame2D:
    def __init__(self):
        ...
        self.car = Car('car.png', 'map.png', [0, 475])
        #self.car = Car('car.png', 'map.png', [800, 80])
        self.game_speed = 60
        self.mode = 0
